...
post_new = PostCreateView.as_view(model=Post, form_class=PostForm,template_name='meeting/add_post.html')
post_edit = UpdateView.as_view(model=Post, form_class=PostForm,template_name = 'meeting/edit_post.html')
post_delete = DeleteView.as_view(model=Post,success_url=reverse_lazy('meeting:post_list'))
...
comment_new = CommentCreateView.as_view(model=Comment,form_class=CommentForm,template_name = 'meeting/add_comment.html')

comment_edit = UpdateView.as_view(model=Comment, form_class=CommentForm,template_name = 'meeting/edit_comment.html')

comment_delete = DeleteView.as_view(model=Comment,success_url=reverse_lazy('meeting:post_list'))