...
#Showing 'freeboard' list function
def list(request):
	list = Post.objects.all().order_by('-created_date')
	return render(request, 'freeboard/list.html', {'list': list})
'''
...
def post_detail(request,pk):
    ...
    return render(request, 'freeboard/post_detail.html',{'post':post,'liked':liked})
...
class PostCreateView(CreateView):
    model = Post
    form_class = PostForm
    template_name = 'freeboard/add_post.html'
...
class CommentCreateView(CreateView):
    ...
    template_name = 'freeboard/add_comment.html'
